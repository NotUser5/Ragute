...
<button id="back-to-top-btn"><i class="	fas fa-angle-up" style='font-size:32px'></i></button>
            ...
            <div id="conec" class="col-md-2 col-sm-12">
                ...
                <ul class="list-inline">
                    <li>
                        ...
                        <a href="https://www.instagram.com/ragute_burger/" target="_blank" id="rede" class="btn">
