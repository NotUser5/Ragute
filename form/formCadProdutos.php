<?php
    ...
    if (isset($_POST) && !empty($_POST)) {
        ...
        if (empty($nome)){
            ...
            $query = "insert into produtos (ID, NOME, VALOR, ATIVO, INGREDIENTES, IMG, ID_CATEGORIA) VALUES (NULL,'$nome', '$valor', '$ativo', '$ingredientes', '$imagem', '$categoria')";
                ...
                <div class="card-body">
                    ...
                    <form action="./formCadProdutos.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-group" id="inserir">
                            ...
                            <textarea class="form-control" aria-label="With textarea" name="ingredientes" placeholder="Uma breve descrição." minlength="6" maxlength="100"></textarea>
                        </div>
