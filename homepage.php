...
<div class="container">
    ...
    <h1><a href="./lanches.php" class="btn" id="categoria">Lanches</a></h1>
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4">
        ...
        <div class="col">
            <div class="card" id="cardHomePage">
                <a href="#">
                    <img class="card-img-top" src="./assets/img/natural.jpg" alt="hamburger">
                </a>
                <div class="card-body">
                    <h5 class="card-title"></h5>
                    <a href="#" class="btn" id="catButton">
        ...
        <div class="col">
            <div class="card" id="cardHomePage">
                <a href="#">
                    <img class="card-img-top" src="./assets/img/frango.jpg" alt="hamburger">
                </a>
                <div class="card-body">
                    <h5 class="card-title"></h5>
                    <a href="#" class="btn" id="catButton">
        ...
        <div class="col">
            <div class="card" id="cardHomePage">
                <a href="#">
                    <img class="card-img-top" src="./assets/img/hotdog.jpg" alt="hamburger">
                </a>
                <div class="card-body">
                    <h5 class="card-title"></h5>
                    <a href="#" class="btn" id="catButton">
